...
namespace DAL
{
    ...
    {
        #region connectionString 数据库连接字符串(app.config来配置)
        ...
        /// <summary>
        /// 查询参数 TableName 的 Max(FieldName)值
        /// </summary>
        ...
        /// <param name="connStr"></param>
        /// <returns></returns>
        public static DataSet Query(string SQLString, string connStr, int times)
        {
            using (SqlConnection connection = new SqlConnection(connStr))
            {
                DataSet ds = new DataSet();
        ...
        /// <param name="SQLString">SQL语句</param>
        /// <returns>影响的记录数</returns>
        public static void ExecuteSql(string SQLString, SqlTransaction tran)
        {
        ...
        /// <param name="SQLString">查询语句</param>
        /// <returns>DataSet</returns>
        public static DataSet Query(string SQLString, int Times,params SqlParameter[] cmdParms)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                SqlCommand cmd = new SqlCommand();
        ...
        private static SqlCommand BuildQueryCommand(SqlConnection connection, string storedProcName, IDataParameter[] parameters)
        {
            ...
            if (parameters != null)
            {
                ...
                //    if (parameter != null)
                //    {
                //        //SqlParameter sp = (SqlParameter)((ICloneable)parameter).Clone();
                //        SqlParameter sp = (SqlParameter)parameter;
                //        // 检查未分配值的输出参数,将其分配以DBNull.Value.
        ...
        /// <param name="rowsAffected">影响的行数</param>
        /// <returns></returns>
        public static int RunProcedure(string storedProcName, IDataParameter[] parameters, SqlTransaction tran, out int rowsAffected)
        {
            int result;
            SqlCommand command = BuildIntCommand(tran.Connection, storedProcName, parameters);
            command.Transaction = tran;
            rowsAffected = command.ExecuteNonQuery();
            result = (int)command.Parameters["ReturnValue"].Value;
            command.Parameters.Clear();
