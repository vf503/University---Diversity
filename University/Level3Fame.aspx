<%@ Page Language="C#" MasterPageFile="~/MasterPager/Normal.Master" AutoEventWireup="true" CodeBehind="Level3Fame.aspx.cs" Inherits="colleges.Level3Fame" %>
...
<%--                    <h3>机构索引</h3>   
                    <asp:ListView ID="Lv3OrgList" runat="server">
                        <LayoutTemplate>
                            <div class="">
                                <ul>
                        ...
                        <ItemTemplate>
                          <li><a id="<%# Eval("CategoryAlias") %>" href="Level3Fame.aspx?alias=<%# Eval("CategoryAlias") %>&IsChild=1" target="_self"><%# Eval("CategoryName") %></a></li>
                        </ItemTemplate>
                    </asp:ListView>--%>
                    <h3>
                        <a id="gxchannel10_3" class="Lv3FameSoloLink" href="Level3Fame.aspx?alias=gxchannel10_3&IsChild=1"
                            target="_self">名家谈时事</a></h3>
                    <ul>
                        <li></li>
                    </ul>
                    <h3>
                        <a id="gxchannel10_2" class="Lv3FameSoloLink" href="Level3Fame.aspx?alias=gxchannel10_2&IsChild=1"
                            target="_self">名家谈管理</a></h3>
                    <ul>
                        <li></li>
                    </ul>
                    <h3>音序索引</h3>   
                    <asp:ListView ID="Lv3InitialList" runat="server" GroupItemCount="5">
                        ...
                        <ItemTemplate>
                          <div class="Lv3InitialBox"><a id="<%# Eval("CategoryAlias") %>" href="Level3Fame.aspx?alias=<%# Eval("CategoryAlias") %>&IsChild=1" class="Lv3InitialLink" target="_self"><%# Eval("CategoryName") %></a></div>
                        </ItemTemplate>
                    </asp:ListView>
                     <h3>专家名录</h3>   
