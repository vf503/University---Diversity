<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPager/HomeLite.Master" AutoEventWireup="true" CodeBehind="Level3ClassLite.aspx.cs" Inherits="colleges.Level2ClassLite" %>
        ...
        <div id="Level2Main">
            ...
            <span id="HideLv2Alias" class="HideInfoLable"><%=Lv2CategoriesIndex%></span>
                <div class="Level3HotTreeTitle">
                    <asp:Label ID="CurrentCategoryName" runat="server" Text="名校公开课"></asp:Label>
                </div>
                <div class="Level3Tree" id="Level3Tree">
                    <h3>
                        <a id="gxb2_openclass_3" class="Lv3FameSoloLink" href="Level3classLite.aspx?alias=gxb2_openclass_3&IsChild=1"
                            target="_self">精品课程</a></h3>
                    <ul>
                        <li></li>
                    </ul>
                    <h3>
                        <a class="lv3header" href="Level3classLite.aspx?alias=<%=Lv3NaviAlias1%>&IsChild=0"
                    ...
                    <asp:ListView ID="Lv3Navi2" runat="server">
                        ...
                        <ItemTemplate>
                          <li><a id="<%# Eval("CategoryAlias") %>" href="Level3classLite.aspx?alias=<%# Eval("CategoryAlias") %>&IsChild=1" target="_self"><%# Eval("CategoryName") %></a></li>
                        </ItemTemplate>
                    </asp:ListView>
                    <h3>
                        <a class="lv3header" href="Level3classLite.aspx?alias=<%=Lv3NaviAlias1a%>&IsChild=0"
                    ...
                    <h3>
                        <a class="lv3header" href="Level3classLite.aspx?alias=<%=Lv3NaviAlias1b%>&IsChild=0"
                    ...
                    <h3>
                        <a class="lv3header" href="Level3classLite.aspx?alias=<%=Lv3NaviAlias2%>&IsChild=0"
                                ...
                                <li>
                                    <div style="float:left;position:relative">
                                        <a href="ShowVideo.aspx?ID=<%#Eval("ArticleGUID")%>" title="<%#Eval("Title")%>" target="_blank">
                                            <img class="Level3MainListContentDetailPreview" src="<%#colleges.DataQuery.GetCoursePicPath(Eval("ArticleGUID").ToString(),url,"001.jpg")%>" /></a>
                                    </div>
                                    <div class="Level3MainListContentDetailInfo" style="width:500px">
                                        <div class="Level3MainListDetailLeft" style="width:500px">
                                            <div class="Level3MainListDetailTitle">
                                                <a href="ShowVideo.aspx?ID=<%#Eval("ArticleGUID")%>" title="<%#Eval("Title")%>" target="_blank">
                                                    <%# colleges.DataProcessing.SubstringText(Eval("Title").ToString(),34) %></a>
                                            </div>
