            ...
            switch (style) {
                case "left":
                    ...
                    if (KSS_changeFlag >= KSS_imgaeLength) {
                        KSS_changeFlag = 0;
                        //alert(KSS_changeFlag); //OnMove
                        $(ksbs).find("#KSS_moveBox").scrollLeft(0);
                        $(ksbs).find("#KSS_moveBox").animate({
                            scrollLeft: KSS_Size[0]
                        }, settings.moveSpeedTime);
                        //OnMove
                        $('.FocusContent .FocusContentListShow').removeClass("FocusContentListShow").addClass("FocusContentListHide");
                        $('.FocusContent li').eq(KSS_changeFlag + 1).removeClass("FocusContentListHide").addClass("FocusContentListShow");
                    } else {
                        sp = (KSS_changeFlag + 1) * KSS_Size[0];
                        var CountLi = $("#KinSlideshow").find("img").size();
                        //alert(sp/KSS_Size[0]+"_"+CountLi/2);//AutoMove
                        ...
                        //AutoMove
                        PageCount = sp / KSS_Size[0];
                        if (PageCount == 5) {PageCount=0};
                        $('.FocusContent .FocusContentListShow').removeClass("FocusContentListShow").addClass("FocusContentListHide");
                        $('.FocusContent li').eq(PageCount).removeClass("FocusContentListHide").addClass("FocusContentListShow");
                    }
