<%@ Page Language="C#" MasterPageFile="~/MasterPager/Normal.Master" AutoEventWireup="true" CodeBehind="Level3Navi.aspx.cs" Inherits="colleges.Level3Navi" %>
        ...
        <div id="Level2Main">
            ...
            <span id="HideLv2Alias" class="HideInfoLable"><%=Lv2CategoriesIndex%></span>
                ...
                <asp:ListView ID="Lv3Navi" runat="server" OnItemDataBound="Lv3Navi_ItemDataBound">
                    <ItemTemplate>
                        <a id="<%# Eval("CategoryAlias") %>" class="lv3header" href="Level3Navi.aspx?alias=<%# Eval("CategoryAlias") %>&IsChild=0" target="_self">
                            <%# Eval("CategoryName")%></a>
                        <div>
                            ...
                            <ul>
                                <asp:ListView ID="Lv3NaviLv2Items" runat="server" OnItemDataBound="Lv3NaviLv2Items_ItemDataBound">
                                    <ItemTemplate>
                                        ...
                                        <li class="Lv3NaviLv2li"><div class="Lv3NaviLv2Item"><a id="<%# Eval("CategoryAlias") %>" href="Level3Navi.aspx?alias=<%# Eval("CategoryAlias") %>&IsChild=0" target="_self">
                                            <%# colleges.DataProcessing.SubstringText(Eval("CategoryName").ToString(),10) %></a></div>
                                            <asp:ListView ID="Lv3NaviLv3Items" runat="server">
                                                <ItemTemplate>
                                                    <li class="Lv3NaviLv3li"><a id="<%# Eval("CategoryAlias") %>" href="Level3Navi.aspx?alias=<%# Eval("CategoryAlias") %>&IsChild=1" target="_self">
