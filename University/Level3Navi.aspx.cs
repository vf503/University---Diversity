...
namespace colleges
{
    public partial class Level3Navi : System.Web.UI.Page
    {
        public string url;
        ...
        protected void PicBtn_Click(object sender, ImageClickEventArgs e)
        {
            ...
            switch (ListType)
            {
                case "pic":
                    break;
                case "text":
                    RedirectUrl = "Level3Navi.aspx?alias=" + alias + "&IsChild=" + IsChild + "&type=pic&order=" + ListOrder;
        ...
        protected void TextBtn_Click(object sender, ImageClickEventArgs e)
        {
            ...
            switch (ListType)
            {
                case "text":
                    break;
                case "pic":
                    RedirectUrl = "Level3Navi.aspx?alias=" + alias + "&IsChild=" + IsChild + "&type=text&order=" + ListOrder;
                    Response.Redirect(RedirectUrl);
                    break;
                default:
                    RedirectUrl = "Level3Navi.aspx?alias=" + alias + "&IsChild=" + IsChild + "&type=text&order=" + ListOrder;
        ...
        protected void RadioDesc_CheckedChanged(object sender, EventArgs e)
        {
            ...
            switch (RadioDesc.Checked)
            {
                case true:
                    ListOrder = "desc";
                    RedirectUrl = "Level3Navi.aspx?alias=" + alias + "&IsChild=" + IsChild + "&type=" + ListType + "&order=" + ListOrder;
                    Response.Redirect(RedirectUrl);
                    break;
                case false:
                    ListOrder = "asc";
