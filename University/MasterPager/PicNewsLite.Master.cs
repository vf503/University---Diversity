...
{
    public partial class PicNewsLite : System.Web.UI.MasterPage
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            //导航
            string NewsCategoriesAlias = ConfigurationManager.AppSettings["NewsCommendAlias"];
            DataTable NewsCategoriesData = DataQuery.GetSubCategories(NewsCategoriesAlias);
            SpecialAttentionNav.DataSource = NewsCategoriesData;
            SpecialAttentionNav.DataBind();
        }
        //
