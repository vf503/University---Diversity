<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SpecialIndex.aspx.cs" Inherits="colleges.SpecialIndex" Title="中经视频高校新版" %>
                ...
                <asp:ListView ID="HistoryList" runat="server">
                    <ItemTemplate>
                        <li><span class="Level2TopNumBg1">
                            <%#Eval("Seq")%></span></span> <span><a href="SpecialAttention.aspx?ID=<%#Eval("CategoryGuid")%>&Title=<%#HttpUtility.UrlEncode(Eval("CategoryName").ToString())%>"
                                target="_blank">
...
$(function(){
    $("input[type=button].SpecialAttentionSearchBtn")
        ...
        .click(function(){
            ...
            location.href="Search.aspx?act=zt&keywords="+sKey;
    });
});  
</script>
</asp:Content>
