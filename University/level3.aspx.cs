    ...
    public partial class level3 : System.Web.UI.Page
    {
        ...
        protected void PicBtn_Click(object sender, ImageClickEventArgs e)
        {
            ...
            switch (ListType)
            {
                case "pic":
                    break;
                case "text":
                    RedirectUrl = "level3.aspx?alias=" + alias + "&IsChild="+ IsChild +"&type=pic&order=" + ListOrder;
        ...
        protected void TextBtn_Click(object sender, ImageClickEventArgs e)
        {
            ...
            switch (ListType)
            {
                case "text":
                    break;
                case "pic":
                    RedirectUrl = "level3.aspx?alias=" + alias +  "&IsChild="+ IsChild +"&type=text&order=" + ListOrder;
                    Response.Redirect(RedirectUrl);
                    break;
                default:
                    RedirectUrl = "level3.aspx?alias=" + alias + "&IsChild=" + IsChild + "&type=text&order=" + ListOrder;
        ...
        protected void RadioDesc_CheckedChanged(object sender, EventArgs e)
        {
            ...
            switch (RadioDesc.Checked)
            {
                case true:
                    ListOrder = "desc";
                    RedirectUrl = "level3.aspx?alias=" + alias +  "&IsChild="+ IsChild +"&type=" + ListType + "&order=" + ListOrder;
                    Response.Redirect(RedirectUrl);
                    break;
                case false:
                    ListOrder = "asc";
